...
## Customer dealing
- New customers are quoted a higher initial price (until the job/relationship is better understood).
- Established customers are locked into set prices.
- One customer's price is never revealed to another — kept strictly confidential across customers.
...
## Credit / Outstanding
- Some set customers (e.g. PreVal, Akshar, Kepler) run on credit terms rather than paying per job — an outstanding balance builds up against them over time.
