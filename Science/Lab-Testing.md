...
- What a full-panel report covers, all tests by one lab:
  ...
  7. Coating thickness
  8. Salt spray
- The decarb-specific gotcha (a decarbed skin lies to a surface hardness test — grind first or test a cross-section) is in [[Metallurgy]], Decarburization.
...
- **HRA** is for thin material like metal sheets. Indenter and load for the two bulk-material scales:
